...
extern long __ESBMC_PY_TARGET(long selector, long e0, long e1);
extern int  __ESBMC_C_TARGET(int selector, int e0, int e1);
...
int equiv_main(void)
{
    ...
    long r_py =
        (long)__ESBMC_PY_TARGET((long)selector, (long)e0, (long)e1);

    long r_c =
        (long)__ESBMC_C_TARGET(selector, e0, e1);
